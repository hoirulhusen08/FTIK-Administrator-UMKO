    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="https://codeigniter.com/user_guide/" target="_blank">Tentang</a>
                </li>
                <li class="menu-item hidden"><a href="https://forum.codeigniter.com/" target="_blank">Pengajuan Surat</a></li>
                <li class="menu-item hidden"><a href="https://codeigniter.com/contribute" target="_blank">Kontak</a>
                    <?php if (logged_in()) : ?>
                <li class="menu-item hidden"><a href="<?= base_url('logout'); ?>">Logout</a>
                </li>
            <?php else : ?>
                <li class="menu-item hidden"><a href="<?= base_url('login'); ?>">Login</a>
                </li>
            <?php endif; ?>
            </ul>
        </div>
